    ...
    return(
        <main className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div>
                    <button onClick={() => onRouteChange('home')} type="submit" className="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Sign in</button>
                </div>
                </form>
                <p onClick={() => onRouteChange('register')} className="mt-10 text-center font-semibold text-indigo-400 hover:text-indigo-300 cursor-pointer">Register</p>
            </div>
        </main>
    )
}
